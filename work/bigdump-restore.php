<?php 
/*
if(isset($__GET['start']))
{
    ?>
    <iframe src="https://database-backup.com/bigdump-restore/bigdump.php" title="W3Schools Free Online Web Tutorials"></iframe> 
    <?php
        // require_once('bigdump.inc');
    // die();
}
*/
...
if(!file_exists('bigdump.inc') and file_exists('bigdump.php') and filesize('bigdump.php') == 40318 )
{
    ...
    $new_text2 = substr($new_text, 0, $pos-20);

    $toadd = "require_once('header.inc');
    ";
    $new_text2 .= $toadd . substr($new_text2, $pos+21);
    ...
    /*
    echo '<center><big>';
    echo 'Instructions to use BigDump script. ';
    echo '<a href="https://bigdumprestore.com/bigdump-help/">Please, read!</a>';
    echo '<br>';
    echo 'After click Start Import, Wait for the script to finish, do not close the browser window';
    echo '</big></center>';
    echo '<hr>';
    echo '<br>';
    */
